...
public class InformacoesUsuarioTest {
    ...
    public void testAdicionarUmaInformacaoAdicionalDoUsuario(@Param(name="tipo")String tipo, @Param(name="contato")String contato, @Param(name="mensagem")String mensagemEsperada) {
        ...
        // Identificar a popuu onde está o formulário de id addmoredata
    ...
    public void removerUmContatoDeUmUsuario() {
        ...
        String screenshotArquivo = "C:/Users/Sempre IT/Pictures/test-report/" + Generator.dataHoraParaArquivo() + test.getMethodName() + ".png";
    ...
    public void tearDown() {
        // Fechar o navegador
        // "quit" fecha todas as abas do navegador, close "fecha" apenas uma.
        //navegador.quit();
    }
}
